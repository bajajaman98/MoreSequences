...
def rectangles_from_circles(circles):
    ...
    for k in range(len(circles)):
        top_left = rg.Point(circles[k].center.x-circles[k].radius,circles[k].center.y - circles[k].radius)
        bot_right = rg.Point(circles[k].center.x+circles[k].radius,circles[k].center.y+circles[k].radius)
        rect = rg.Rectangle(top_left,bot_right)
        rectangles += [rect]
    return rectangles
    """
