...
def run_test_generate_points_on_circle():
    ...
    # ------------------------------------------------------------------
    expected = [rg.Point(175.0, 125.0),  # All numbers are approximate.
                rg.Point(125.0, 175.0),
                rg.Point(87.5, 71.7),
                rg.Point(87.5, 28.3)]
...
def draw_points_on_circle(window, circle, number_of_points, color):
    ...
    for k in range(len(points)):
        corcle = rg.Circle(points[k],10)
        corcle.fill_color = color
        corcle.attach_to(window)
...
def run_test_pizza():
    ...
    # ------------------------------------------------------------------
    title = 'PIZZA test 4:  10 slices, thin (thickness=1) black lines on yellow circle.'
    window = rg.RoseWindow(400, 400, title)
    circle = rg.Circle(rg.Point(200, 200), 175)
    circle.outline_thickness = 3
    pizza(window, circle, 10, 'yellow', 1)
    window.close_on_mouse_click()
...
def run_test_polygon():
    ...
    # ------------------------------------------------------------------
    title = 'POLYGON test 3: 4 segments with thin black lines on purple circle'
    window = rg.RoseWindow(400,400,title)
    circle = rg.Circle(rg.Point(200,200),175)
    circle.fill_color = 'purple'
...
def run_test_fancy_polygon():
    ...
    # ------------------------------------------------------------------
    title = 'FANCY POLYGON test 4:  10 yellow lines on red circle, hops = 2.'
    window = rg.RoseWindow(400, 350, title)
    circle = rg.Circle(rg.Point(200, 200), 150)
    circle.fill_color = 'red'
    fancy_polygon(window, circle, 10, 2, 'yellow', 4)
    window.close_on_mouse_click()
...
def fancy_polygon(window, circle, number_of_lines, hops_to_next_point, color, thickness):
    ...
    circle.attach_to(window)
    for k in range(len(points)):
        if k < len(points) - hops_to_next_point:
